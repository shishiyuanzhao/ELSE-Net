...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input",  default="output/trained_vit_b16/inference/sem_seg_predictions.json"
    )
    parser.add_argument("--output",  default="output/viz")
    parser.add_argument(
        "--dataset", help="name of the dataset", default="ade20k_sem_seg_val"
    )
    parser.add_argument(
        "--conf-threshold", default=0.5, type=float, help="confidence threshold"
    )
    args = parser.parse_args()
    args.input = "output/trained_vit_b16/inference/sem_seg_predictions.json"
    args.output = "output/viz"
