...
def add_san_config(cfg):
    ...
    # san
    cfg.MODEL.SAN = CN()
    cfg.load_pre_clipn = False
    cfg.MODEL.SAN.NO_OBJECT_WEIGHT = 0.1
    cfg.MODEL.SAN.CLASS_WEIGHT = 0.5
    cfg.MODEL.SAN.MASK_WEIGHT = 2
    cfg.MODEL.SAN.DICE_WEIGHT = 2
    ...
    cfg.MODEL.SAN.CLIPN_MODEL_NAME = "ViT-B-16"
    cfg.MODEL.SAN.CLIP_PRETRAINED_NAME = "openai"
    cfg.pretrain="/root/autodl-tmp/SAN-main/san/model/CLIPN_ATD_Repeat2_epoch_10.pt"
